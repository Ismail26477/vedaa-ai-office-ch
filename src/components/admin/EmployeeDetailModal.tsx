...
import { MapPin, Clock, Calendar, CheckCircle2, AlertCircle, Camera } from "lucide-react"
...
export function EmployeeDetailModal({ isOpen, onClose, employeeName, employeeId, records }: EmployeeDetailModalProps) {
          ...
          <TabsContent value="verification" className="space-y-4">
            <Card>
              ...
              <CardContent className="space-y-4">
                {(() => {
                  const recordsWithPhotos = records.filter((r) => r.photoData || r.checkOutPhotoData)
                  console.log("[v0] Records with photos:", recordsWithPhotos.length, "out of", records.length)
